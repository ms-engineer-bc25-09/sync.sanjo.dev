...
function buildLedgerRowFromGeminiResult_(options) {
  ...
  return {
    ...
    email: options.email || result.email || '',
    emailSource: options.emailSource || result.email_source || '',
    phone: options.phone || result.phone || '',
    phoneSource: options.phoneSource || result.phone_source || '',
    inquiry: inquiry,
